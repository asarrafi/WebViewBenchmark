...
/**
* @brief The NGEO Map will contain the Nokia map controls and will allow the user to interact with the map.
* See \ref WidgetNGEOMapProperties "NGEO Map properties" for the properties available.
*/
mosync.MAW_NGEO_MAP = "NGEOMap";

/**
        * \brief No error occurred.
        */
mosync.MAW_NMAP_RES_OK = 0;

/**
        * \brief Indicates that there was an error connecting to the network.
* Platform: Android. TODO maybe delete this oene.
        */
mosync.MAW_NMAP_RES_CONNECTION_ERROR = -1;

/**
        * \brief Indicates that there was an error while handling an object.
* Platform: Android.
        */
mosync.MAW_NMAP_RES_INVALID_OBJECT_HANDLE = -2;

/**
*
*/
mosync.MAW_CONSTANT_STATE_STARTED = 1;

/**
*
*/
mosync.MAW_CONSTANT_STATE_CHANGING = 2;

/**
*
*/
mosync.MAW_CONSTANT_STATE_ENDING = 3;

/**
* \brief Sent when the map center position starts to change,
* is changing, or finished changing.
* Check the event state member object from event's ngeodata struct for more info.
*/
mosync.MAW_NMAP_EVENT_MOVE = 1;

/**
* \brief
*/
mosync.MAW_NMAP_EVENT_ZOOM_LEVEL = 2;

/**
* \brief
*/
mosync.MAW_NMAP_EVENT_MAX_SCALE_CHANGED = 3;

/**
* \brief
*/
mosync.MAW_NMAP_EVENT_ANIMATE = 4;

/**
* \brief
*/
mosync.MAW_NMAP_EVENT_ORIENTATION = 5;

/**
* \brief
*/
mosync.MAW_NMAP_EVENT_PERSPECTIVE = 6;

/**
* \brief Point of Interest object.
*/
mosync.MAW_NMAP_OBJECT_POI = 1;

/**
* \brief Icon object.
*/
mosync.MAW_NMAP_OBJECT_ICON = 2;

/**
* \brief Full detail level.
*/
mosync.MAW_NMAP_DETAIL_LEVEL_FULL = 1;

/**
* \brief Less detail level.
*/
mosync.MAW_NMAP_DETAIL_LEVEL_LESS = 2;

/**
* \brief Least detail level.
*/
mosync.MAW_NMAP_DETAIL_LEVEL_LEAST = 3;

/**
* \brief No animation is performed.
*/
mosync.MAW_NMAP_ANIMATION_NONE = 1;

/**
* \brief Linear animation is performed.
*/
mosync.MAW_NMAP_ANIMATION_LINEAR = 2;

/**
* \brief Bow animation is performed. TODO document this.
*/
mosync.MAW_NMAP_ANIMATION_BOW = 3;

/**
* @brief Sets or gets the detail level on the map.
*
* The default value is: TODO
* @validvalue An int, one of the following values:
*     - #MAW_NMAP_DETAIL_LEVEL_FULL,
*     - #MAW_NMAP_DETAIL_LEVEL_LESS,
*     - #MAW_NMAP_DETAIL_LEVEL_LEAST.
*
* @setandget
*
* @par Example set
* \code
*	maWidgetSetProperty(mapHandle, MAW_NGEO_MAP_DETAIL_LEVEL, MAUtil::integerToString(MAW_NMAP_DETAIL_LEVEL_FULL));
* \endcode
*/
mosync.MAW_NGEO_MAP_DETAIL_LEVEL = "ngeoMapDetailLevel";

/**
* @brief Sets or gets the latitude for the center of the map. TODO the default values.
*
* @validvalue A float, the east-west coordinate (x-axis on a map), as measured in degrees.
* Double-precision latitude value, a range between -90.0 and 90. inclusive.
* If an invalid value is specified, it will be adjusted to the closest possible latitude value.
* (e.g. a specified value of -100 will be set to -90.0)
*
* @setandget
*
* @par Example set
* \code
*	maWidgetSetProperty(mapHandle, MAW_NGEO_MAP_CENTER_LATITUDE, "49.196261"));
* \endcode
*/
mosync.MAW_NGEO_MAP_CENTER_LATITUDE = "centerLatitude";

/**
* @brief Sets or gets the longitude for the center of the map.
*
* @validvalue A float, the north-south coordinate (y-axis on a map), as measured in degrees.
* Double-precision longitude value, a range between -180.0 and less than 180.0 inclusive.
* If an invalid value is specified, it will be adjusted to the closest possible longitude value
* (e.g. a specified value of -200.0 will be set to 160.0)
*
* @setandget
*
* @par Example set
* \code
*	maWidgetSetProperty(mapHandle, MAW_NGEO_MAP_CENTER_LONGITUDE, "-123.004773"));
* \endcode
*/
mosync.MAW_NGEO_MAP_CENTER_LONGITUDE = "centerLongitude";

/**
* @brief Enables or disables animation when the map is programmatically moved or scaled.
* The default value is #MAW_NMAP_ANIMATION_NONE.
*
* @validvalue An int one of the constants:
*    - #MAW_NMAP_ANIMATION_NONE
*    - #MAW_NMAP_ANIMATION_LINEAR.
*    - #MAW_NMAP_ANIMATION_BOW.
*
* @setandget
*
* @par Example set
* \code
*	maWidgetSetProperty(mapHandle, MAW_NGEO_MAP_ANIMATE, MAUtil::integerToString(MAW_NMAP_ANIMATION_LINEAR)));
* \endcode
*/
mosync.MAW_NGEO_MAP_ANIMATE = "animate";

/**
* @brief Sets the map zoom to a fractional level that is within the range of minimum and maximum zoom levels.
* Legal values are the range between getMinZoomLevel() and getMaxZoomLevel() inclusive.
* Note: The animation type set by #MAW_NGEO_MAP_ANIMATE property will be used.
*
* @validvalue A double, the fraction zoom level.
*
* @setandget
*
* @par Example set
* \code
*	maWidgetSetProperty(mapHandle, MAW_NGEO_MAP_ZOOM_LEVEL, "12.5"));
* \endcode
*/
mosync.MAW_NGEO_MAP_ZOOM_LEVEL = "zoomLevel";
